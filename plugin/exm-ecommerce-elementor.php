...
//		add_action('wp_enqueue_scripts', [$this, 'add_resources']);
		add_action('elementor/editor/before_enqueue_scripts', array($this, 'add_resources'));
	}
	
	function add_resources () {
		// regiser font
		wp_register_style('exm_ecom_font', plugins_url('assets/font/styles.css', __FILE__), [], '1');
		wp_enqueue_style('exm_ecom_font');
	}
	...
	function create_custom_categories($elements_manager) {
		...
		$elements_manager->add_category(
				'digital-experience',
				[
					'title' => __('Digital Experience', 'plugin-name'),
					'icon' => 'fa fa-plug',
				]
		);
	}
